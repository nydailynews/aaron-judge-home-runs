...
<head>
    ...
    <script type="application/ld+json">
        {
            ...
            "keywords": ["interactive","interactive project","aaron judge", "Yankees", "Sports"]
        }
    </script>
    <!-- NO NEED TO FILL -->
    ...
    <script data-main="http://assets.nydailynews.com/nydn/js/rh.js?r=20170405001" src="http://assets.nydailynews.com/nydn/js/require.js?r=201706290002" defer></script>
...
<article>
    <div style="text-align: center;">
        <img src="img/aaron-judge.jpg" alt="Photo of Aaron Judge swinging a baseball bat during a game">
        <figcaption>
            <h2 class="ra-caption" itemprop="description">Yankees rookie Aaron Judge hit his 25th home run of the 2017 season on June 22.</h2>
            <span class="ra-credit" itemprop="copyrightHolder">(Mike Stobe/Getty Images)</span>
        </figcaption>
    </div>
  ...
  <div class="ad center">
    ...
    <div id="field">
        ...
        <div id="info" class="hide">
            <h2>Home run #<span id="number"></span></h2>
            <p></p>
        </div>
    </div>
...
<!-- STATS TABLE STARTS HERE -->
    ...
    <div id="container">
        <p id="interface">
            <button onClick="slugger.play(); return false;" id="play">Play</button>
            <button onClick="slugger.pause(); return false;" id="pause" class="hide">Pause</button>
        ...
        <caption>Home Run Details</caption>
            ...
            <thead>
                <tr>
                    <th scope="col"><a>Number</a></th>
                    <th scope="col"><a>Date</a></th>
                    <th scope="col"><a>Distance<br>(in feet)</a></th>
                    <th scope="col"><a>Exit Velocity<br>(in mph)</a></th>
                    <th scope="col"><a>Opponent</a></th>
                    <th scope="col"><a>Pitcher</a></th>
                </tr>
            </thead>
            <tbody></tbody>
        </table>
...
<script>
//function judge_homeruns_callback(data) { slugger.data = data.slice(0,5); slugger.load_ani(); }
...
var slugger = {
    ...
    update_statbox: function(id) {
        ...
        $('#number').text(item['Home-Run-No.']);
        var p = $('#info p');
        var opp = item['Opponent'].replace('-', ' ');
        var dis = item['Distance'];
        if ( dis == '495' ) dis += "<span style='color:red;'>(!)</span>";
    ...
    <td data-label="Distance (feet)">' + item['Distance'] + '</td>\n\
    <td data-label="Exit Velocity (mph)">' + item['Exit-Velocity'] + '</td>\n\
    <td data-label="Opponent">' + item['Opponent'].replace('-', ' ') + '</td>\n\
    <td data-label="Pitcher">' + item['Pitcher'] + '</td>\n\
</tr>';
        $('#homers tbody').append(row);
    },
    process_hits: function() {
        ...
        window.maxHits = slugger.hits.length
        return true;
    },
    interface_: {
        play: function() {
    ...
    play: function() {
        ...
        {
            // On the first press of the play button.
            // One of like four different setup chunks of the script.
            animate();
            slugger.update_statbox(0);
            $('#info').removeClass('hide');
        }
        playpause = 'play';
        this.interface_.play();
        return true;
    },
    pause: function() {
        // Pause the animation
        playpause = 'pause';
        this.interface_.pause();
    },
    end: function() {
        // End the animation
        playpause = 'pause';
...
var ani = {
    ...
    make_ball: function() {
        ...
        scene.add( cube );
        //var start = new THREE.Vector3( 100, 100, 0 );
        //cube.position = start;
        return cube;
    },
    make_line: function() {
